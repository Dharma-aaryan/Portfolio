...
//   return (
//     <section className="relative min-h-screen flex items-center justify-center bg-[var(--portfolio-primary)]">
...
//               </span>
//               <br />
//               <span className="text-[var(--portfolio-text-primary)] whitespace-nowrap">
//                 Data • Software • Product
//               </span>
//             </h1>
//             <p className="text-xl md:text-2xl text-[var(--portfolio-text-secondary)] font-light leading-relaxed mb-8">
//               Driving innovation through scalable software, data-driven systems,
//               and user-focused digital solutions, to enhance business processes
